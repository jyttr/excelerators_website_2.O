...
function Navbar() {
  ...
  function ScrollTo(event, dest) {
    ...
    if (window.location.pathname == "/") {
      ...
      window.scroll({
        top: window.scrollY + distance - window.innerHeight / 11,
        behavior: "smooth",
      });
  ...
  return (
    <>
      <div
        id="navbar"
        style={{ backgroundColor: navbarBackground ? "black" : "transparent" }}
      >
        <div
          id="show_navbar"
          onClick={() => {
        ...
        <div
          id="links"
          style={{
            backgroundColor: linksBackground ? "black" : "transparent",
            left: navbarHidden ? "-50vw" : "0vw",
          }}
        >
          <ul>
            <li>
              {" "}
              <a className="link home_link" href="/">
                HOME
              </a>{" "}
            </li>
            <li>
              {" "}
              <a
                className="link about_us_link"
                href="/about_us"
                onClick={(event) => {
                  ScrollTo(event, "about_us");
                }}
              >
                ABOUT US
              </a>{" "}
            ...
            <li>
              {" "}
              <a
                className="link projects_link"
                href="/projects"
                onClick={(event) => {
                  ScrollTo(event, "projects");
                }}
              >
                PROJECTS
              </a>{" "}
            ...
            <li>
              {" "}
              <a
                className="link events_link"
                href="/events"
                onClick={(event) => {
                  ScrollTo(event, "events");
                }}
              >
                EVENTS
              </a>{" "}
            ...
            <li>
              {" "}
              <a
                className="link members_link"
                href="/members"
                onClick={(event) => {
                  ScrollTo(event, "members");
                }}
              >
                TEAM
              </a>{" "}
            ...
            <li>
              {" "}
              <a
                className="link sponsers_link"
                href="/sponsers"
                onClick={(event) => {
                  ScrollTo(event, "sponsers");
                }}
              >
                SPONSORS
              </a>{" "}
